...
class LDOEnv(gym.Env, CktGraph, DeviceParams):
    ...
    def _get_info(self):
        ...
        # _, self.line_reg_minload = self.sim_results.tran(file_name='ldo_tb_line_reg_minload')
        ...
        # _, self.line_reg_maxload = self.sim_results.tran(file_name='ldo_tb_line_reg_maxload')
